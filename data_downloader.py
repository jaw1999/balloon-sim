...
REQUIRED_GRIB_VARIABLES = ['Temperature', 'Wind', 'Pressure', 't', 'number', 'directionNumber', 'frequencyNumber']  # Update as needed
...
def download_gfs_data(date_entry, cycle_runtime, forecast_hour, save_path):
    ...
    url = f"https://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs.{date_entry}/{cycle_runtime}/atmos/{filename}"
